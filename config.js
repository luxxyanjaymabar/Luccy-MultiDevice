...
global.nameown = 'LuxxyXD' // Nama Owner


/*============== STAFF ==============*/
global.owner = [
  ['6288210072756', '❦ LuxxyXD? 🎐', true] //Ganti jd nomormu sama Namamu
...
/*============== WATERMARK ==============*/
global.wm = '                「 ʟᴜᴄᴄʏ ʙᴏᴛ 汉  」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘𝐋𝐮𝐜𝐜𝐲-𝐁𝐨𝐭˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ 𝙻𝚞𝚌𝚌𝚢𝙱𝚘𝚝'
...
/*============== STICKER WM ==============*/
global.stickpack = '.'
global.stickauth = `☂︎ʟᴜᴄᴄʏ-ʙᴏᴛ⫹⫺ Whatsapp BOT\nwa.me/${global.nomorbot}`
global.packname = 'ʟᴜxxʏxᴅ'
global.packname2 = '𝕮𝖗𝖊𝖆𝖙𝖊𝖉 𝕭𝖞 𝔏𝔲𝔵𝔵𝔶𝔛𝔇'
